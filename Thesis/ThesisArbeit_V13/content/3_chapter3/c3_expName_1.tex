...
\begin{gather*}
	Punkt = \, <|Coordx \rightarrow x_i, Coordy \rightarrow y_i, CellI \rightarrow i_i, CellJ \rightarrow j_i |>
\end{gather*} \\
...
Der die $Assiciation$-Liste des Startpunktes wird um zwei weitere Schlüssel erweitert. Die Schlüssel $NeighbourI$ und $NeighbourJ$
(HIER WEITER MACHEN)
