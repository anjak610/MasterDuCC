...
Für Disparity maps müssen die horizontalen werte auf die selbe reihe passen. Epipolar rectification is an important stage in dense stereo
matching, as almost any stereo algorithm requires rectified
images, i.e., images where epipolar lines are parallel and
horizontal and corresponding points have the same vertical
coordinates.  \cite{Javier,Fusiello,}\\
...
\subsection{eigens implementierter ansatz}

erlären warum, erklären welches ziel verfolgt der Ansatz --> Rektifizeirung mit unterschiedlichen bildaufnahmen. vllt möglich??
