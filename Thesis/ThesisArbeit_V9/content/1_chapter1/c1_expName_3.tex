...
\begin{minipage}{\linewidth}
	...
	\captionof{figure}{Das Weltkoordinatensystem  $(O,\delta)$ und das Kamerakoordinatensystem $(C,\beta)$ sind deckungsgleich definiert. Das Kamerakoordinatensystem $(C',\beta')$ ist bezüglich $(C,\beta)$ verschoben und rotiert.}
...
Mit dem Ergebnis der SVD von $E$ mit \ensuremath{\text{SVD}(E) = USV^T} lassen sich jeweils zwei mögliche Lösungen für $S$ und $R'$ aufstellen\cite{HZ,Ferid}.
